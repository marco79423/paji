...
@router.get('/api/jessigod/random-saying', response_model=schemas.SayingOut)
async def get_sayings(
        origin: Optional[str] = Query(
            None,
            title='來源',
...
@router.post('/api/jessigod/sayings', status_code=201, response_model=schemas.SayingOut)
...
@router.put('/api/jessigod/sayings/{saying_id}', response_model=schemas.SayingOut)
...
@router.delete('/api/jessigod/sayings/{saying_id}', response_model=None)
